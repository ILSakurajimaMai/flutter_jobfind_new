...
final CvDto defaultDummyCv = CvDto(
  ...
  educations: [
    CvEducationDto(
      ...
      description:
          'Đạt giải Nhì cuộc thi "Chiến lược truyền thông sáng tạo" do khoa PR tổ chức',
    ),
  ],
  certificates: [
    CvCertificateDto(
